...
var category = getPluginParameter("type");
var amount = getPluginParameter("amount");
var networkCell = getPluginParameter("network");
var reloadlyId = getPluginParameter("reloadlyId");
var reloadlySecret = getPluginParameter("reloadlySecret");
var phone = getPluginParameter("phone");
var incentive_reference = getPluginParameter("reference");
var project = getPluginParameter("project");
var ip_address ="";
var isoName =  "ZA";//getPluginParameter("isoName");
var URL =""

reqData = {"Network":networkCell,
          "Amount": amount ,
          "Cellphone":phone,
          "Category": category,
          "Incentive_Reference": incentive_reference,
          "Project": project}
